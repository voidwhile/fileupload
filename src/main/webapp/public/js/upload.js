...
$(function(){
    ...
    uploader = WebUploader.create({ 
           auto:false, //是否自动上传
            ...
            swf: path+'/public/webuploader-0.1.5/Uploader.swf',  //在这里必需要引入swf文件，webuploader初始化要用
            //fileVal:'multiFile',  //自定义file的name属性，我用的版本是0.1.5 ,打开客户端调试器发现生成的input 的name 没改过来。
                                             ...
                                             // 建议作者有时间把这个BUG改改啊，搞死人了。。
            server: path+"/webUploader.do", //后台处理上传的方法
